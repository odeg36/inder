 ...
 *
 * @ORM\Table(name="eps")
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\EpsRepository")
 */
class Eps {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Sonata\UserBundle\Entity\User", mappedBy="eps",cascade={"persist"})
     */
    private $usuarios;
