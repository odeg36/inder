 ...
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\OcupacionRepository")
 */
class Ocupacion {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Sonata\UserBundle\Entity\User", mappedBy="ocupacion",cascade={"persist"})
     */
    private $usuarios;
