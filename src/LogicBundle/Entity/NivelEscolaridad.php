 ...
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\NivelEscolaridadRepository")
 */
class NivelEscolaridad {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Sonata\UserBundle\Entity\User", mappedBy="nivelEscolaridad",cascade={"persist"})
     */
    private $usuarios;
