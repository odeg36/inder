 ...
 *
 * @ORM\Table(name="establecimiento_educativo")
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\EstablecimientoEducativoRepository")
 */
class EstablecimientoEducativo {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Sonata\UserBundle\Entity\User", mappedBy="establecimientoEducativo",cascade={"persist"})
     */
    private $usuarios;
