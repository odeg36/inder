 ...
 * FaseEntrenamiento
 *
 * @ORM\Table(name="fase_entrenamiento")
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\FaseEntrenamientoRepository")
 */
class FaseEntrenamiento {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Anamnesis", mappedBy="faseEntrenamiento")
     */
    private $anamnesis
