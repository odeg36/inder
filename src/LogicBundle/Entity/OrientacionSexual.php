 ...
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\OrientacionSexualRepository")
 */
class OrientacionSexual {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Sonata\UserBundle\Entity\User", mappedBy="orientacionSexual");
     */
    private $usuarios;
