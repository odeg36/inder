 ...
 * PresenciaDolor
 *
 * @ORM\Table(name="presencia_dolor")
 * @ORM\Entity(repositoryClass="LogicBundle\Repository\PresenciaDolorRepository")
 */
class PresenciaDolor {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Anamnesis", mappedBy="presenciaDolor")
     */
    private $anamnesis
