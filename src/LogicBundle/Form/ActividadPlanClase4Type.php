...
class ActividadPlanClase4Type extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('claveObservacion', EntityType::class, array(
                    'class' => 'LogicBundle:ClaveObservacion',
                    'placeholder' => '',
                    'label' => 'formulario_plan_clases.labels.clave_observacion',
                    'empty_data' => null,
                    "constraints" => $noVacio,
                    'attr' => [
                        'class' => 'form-control', 'autocomplete' => 'off'
