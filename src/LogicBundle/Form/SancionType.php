...
use AdminBundle\Form\EventListener\EncuentroSistemaUno\AddSancionesFieldSubscriber;
...
class SancionType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ->addEventSubscriber(new AddSancionesFieldSubscriber());
    }
