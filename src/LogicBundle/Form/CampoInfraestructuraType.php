...
use LogicBundle\Form\OpcionCampoInfraestructuraType;

class CampoInfraestructuraType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $noVacio = array(
            new NotBlank(array(
                'message' => 'formulario_campo_infraestructura.no_vacio',
            ))
        );
        $builder
            ...
            ->add('opcionCampoInfraestructuras', CollectionType::class, array(
                'entry_type' => OpcionCampoInfraestructuraType::class,
