...
class FixturesAdministrador extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $usuarios = json_decode('[{"tipo_identificacion": "CC","numero_identificacion": "12345678","username": "admin","email": "oscar.estupinan@ito-software.com","enabled": "TRUE","password": "1q2w3e4r5t","roles": "ROLE_SUPER_ADMIN","documentId": 123456}]');
