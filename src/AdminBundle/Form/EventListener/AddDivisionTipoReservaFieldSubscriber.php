...
class AddDivisionTipoReservaFieldSubscriber implements EventSubscriberInterface {
    ...
    private function addDivisionTipoReservaForm($form,  $escenarioDeportivo = null, $tipoReserva = null) {
    ...
    public function preSetData(FormEvent $event) {
        ...
        $tipoReserva = null;
        if($data->getTipoReservaEscenarioDeportivo()){
            $tipoReserva = $data->getTipoReservaEscenarioDeportivo()->getTipoReserva();
        }

        $this->addDivisionTipoReservaForm($form, $escenarioDeportivo, $tipoReserva);
    }
